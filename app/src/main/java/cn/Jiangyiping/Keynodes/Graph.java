...
public class Graph {
    ...
    public int[] Vertex = new int[VertexSize];  //点0-10 11
    ...
    public void unsetMatrix(int i, int j) {  //设置边的权值
    ...
    */
    ...
    public int[] DijkstraAlogrim() {
        ...
        for (int w = 0; w < 3; w++) {
            ...
            EndAnswer[ans] = -MAX;
            maxanswer = -MAX; //可能的情况是为负数 因此负无穷才能小到底
